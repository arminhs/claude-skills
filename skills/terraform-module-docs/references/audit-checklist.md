...
| 9 | Every example and module covered | every `examples/*/` and every directory under `modules/` (recursively) containing `*.tf` appears in the table | Example without README is reported; Nested module is audited |
